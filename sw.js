 ...
 */
const CACHE = 'knowyoursponsor-v49';
...
const SHELL = [
  ...
  './manifest.json',
  './app.js?v=33',
  './product-metrics.js?v=5',
  './job-title-logic.js?v=2',
  './vacancy-intelligence.js?v=2',
  './occupation-ranking.js?v=2',
  './vacancy-rules.js?v=1',
  './market-pulse.js?v=3',
  './job-helper.js?v=15',
  './job-decision.js?v=2',
  './job-helper.css?v=13',
  './search-results.css?v=7',
  './favicon.png',
